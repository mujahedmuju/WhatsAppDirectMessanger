...
public class DownloadedStatusFragment extends Fragment {
    FragmentDownloadedStatusBinding binding;
    WhatsAppStatusAdapter adapter;
    List<WhatsAppStatusModel> list;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binding = FragmentDownloadedStatusBinding.inflate(inflater,container,false);
        getData();
    ...
    private void getData() {
        ...
        String targetPath = Environment.getExternalStorageDirectory()+"/Download/DirectMSGR_Saver/Whatsapp/";
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if (deleteFile.exists()) {
                            if (deleteFile.delete()) {
                                ...
                                } else Toast.makeText(getContext(), "Video Deleted Successfully", Toast.LENGTH_SHORT).show();
                            } else {
        ...
        binding.savedStatusRecycler.setAdapter(adapter);
